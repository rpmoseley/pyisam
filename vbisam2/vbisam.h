...
#   ifdef _MSC_VER
#       define vbisam_off_t    __int64
#   else
#       define vbisam_off_t    long long
#   endif
#else
#   ifdef _MSC_VER
#       define vbisam_off_t    off_t    /* Microsoft's 'off_t' is a 'signed long' */
#   else
...
#ifdef _MSC_VER
#ifdef VBISAM_LIB
#define VB_DLL_EXPIMP __declspec(dllexport)
#else
#define VB_DLL_EXPIMP __declspec(dllimport)
#endif
#else
#define VB_DLL_EXPIMP
#endif
...
VB_DLL_EXPIMP extern int    isaddindex (const int ihandle, struct keydesc *pskeydesc);
VB_DLL_EXPIMP extern int    isaudit (const int ihandle, char *pcfilename, int imode);
VB_DLL_EXPIMP extern int    isbegin (void);
VB_DLL_EXPIMP extern int    isbuild (const char *pcfilename, const int imaxrowlength,
            struct keydesc *pskey, int imode);
VB_DLL_EXPIMP extern int    ischeck (const char *pcfile);
VB_DLL_EXPIMP extern int    iscleanup (void);
VB_DLL_EXPIMP extern int    isclose (const int ihandle);
VB_DLL_EXPIMP extern int    iscluster (const int ihandle, struct keydesc *pskeydesc);
VB_DLL_EXPIMP extern int    iscommit (void);
VB_DLL_EXPIMP extern int    isdelcurr (const int ihandle);
VB_DLL_EXPIMP extern int    isdelete (const int ihandle, char *pcrow);
VB_DLL_EXPIMP extern int    isdelindex (const int ihandle, struct keydesc *pskeydesc);
VB_DLL_EXPIMP extern int    isdelrec (const int ihandle, vbisam_off_t trownumber);
VB_DLL_EXPIMP extern int    iserase (char *pcfilename);
VB_DLL_EXPIMP extern int    isflush (const int ihandle);
VB_DLL_EXPIMP extern int    isfullclose (const int ihandle);
VB_DLL_EXPIMP extern int    isindexinfo (const int ihandle, void *pskeydesc, const int ikeynumber);
VB_DLL_EXPIMP extern int    islock (const int ihandle);
VB_DLL_EXPIMP extern int    islogclose (void);
VB_DLL_EXPIMP extern int    islogopen (const char *pcfilename);
VB_DLL_EXPIMP extern int    isopen (const char *pcfilename, int imode);
VB_DLL_EXPIMP extern int    isread (const int ihandle, char *pcrow, int imode);
VB_DLL_EXPIMP extern int    isrecover (void);
VB_DLL_EXPIMP extern int    isrelcurr (const int ihandle);
VB_DLL_EXPIMP extern int    isrelease (const int ihandle);
VB_DLL_EXPIMP extern int    isrelrec (const int ihandle, const vbisam_off_t trownumber);
VB_DLL_EXPIMP extern int    isrename (char *pcoldname, char *pcnewname);
VB_DLL_EXPIMP extern int    isrewcurr (const int ihandle, char *pcrow);
VB_DLL_EXPIMP extern int    isrewrec (const int ihandle, const vbisam_off_t trownumber,
            char *pcrow);
VB_DLL_EXPIMP extern int    isrewrite (const int ihandle, char *pcrow);
VB_DLL_EXPIMP extern int    isrollback (void);
VB_DLL_EXPIMP extern int    issetcollate (const int ihandle, const unsigned char *collating_sequence);
VB_DLL_EXPIMP extern int    issetunique (const int ihandle, const vbisam_off_t tuniqueid);
VB_DLL_EXPIMP extern int    isstart (const int ihandle, struct keydesc *pskeydesc,
            int ilength, char *pcrow, int imode);
VB_DLL_EXPIMP extern int    isuniqueid (const int ihandle, vbisam_off_t *ptuniqueid);
VB_DLL_EXPIMP extern int    isunlock (const int ihandle);
VB_DLL_EXPIMP extern int    iswrcurr (const int ihandle, char *pcrow);
VB_DLL_EXPIMP extern int    iswrite (const int ihandle, char *pcrow);

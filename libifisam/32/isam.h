...
typedef struct tuple_hdr
    ...
    long         th_rowid;           /* ROW ID for a buffered tuple         */
    long         th_fragid;          /* FRAGMENT ID for a buffered tuple    */
    long         th_keyhash;         /* hash value for a given key          */
    long         th_tuphash;         /* hash value for the entire tuple     */
...
typedef struct buft_hdr
    ...
    long         bh_status;           /* error codes for this packet        */
